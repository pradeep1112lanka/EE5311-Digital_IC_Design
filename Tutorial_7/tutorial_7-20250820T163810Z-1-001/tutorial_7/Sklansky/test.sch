...
C {verilog_code.sym} -1170 80 0 0 {name=s3 string="
module GP(A,B,G,P);
input A,B;
output G,P;
assign G = A&B;
...
C {verilog_code.sym} -1170 530 0 0 {name=s4 string="
